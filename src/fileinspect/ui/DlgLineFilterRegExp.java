...
public class DlgLineFilterRegExp extends JDialog{
	 ...
	 */
	//public DlgLineFilterRegExp(Frame owner, String title, boolean modal, String aCurrentCharCount) throws HeadlessException {
	public DlgLineFilterRegExp(Frame owner, String title, boolean modal) throws HeadlessException {
	...
	private void initComps(){
		...
		iLbMessage.setText("Enter line filter regr expr:");
	...
	private class ConfirmActionListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			iIsConfirmed = true;
			DlgLineFilterRegExp.this.setVisible(false);
		}
	}
